...
- [**Databricks Medallion Anomaly Detection**]([https://github.com/Tahernezhad/My-LLM-Learning-Journey](https://github.com/Tahernezhad/Databricks-Medallion-Anomaly-Detection)) — Production-style Databricks data pipeline plus unsupervised anomaly detection for micromobility fleet safety.
